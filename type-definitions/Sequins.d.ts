...
declare namespace Sequins {
   ...
   */
  export interface Map<K, V> extends Concrete<K, V>, Keyed<K, V> {
    /**
   ...
   * and NaN.
   */
  export interface Set<T> extends Concrete<T, T>, Duplicated<T> {
    toArray(): Array<T>;
    toJS(): Array<any>;
    toJSON(): Array<T>;
    toSeq(): SetSequence<T>;
   ...
   * discarded.
   */
  export interface IndexedSequence<T> extends Sequence<number, T>, Indexed<T> {
    // Conversions
   ...
   * [K, V] tuples.
   */
  export interface KeyedSequence<K, V> extends Sequence<K, V>, Keyed<K, V> {
    /**
   ...
   */
  export interface SetSequence<T> extends Sequence<T, T>, Duplicated<T> {
    /**
